...
const HOOKS = [
  ...
  { name: 'terminal-guard',      kind: 'guard', event: 'PreToolUse',       desc: 'blocks the /terminal handoff (open/osascript to Terminal) in auto/yolo mode, where nothing is confirmed' },
