...
- **AUTHORIZED**: confirm briefly that main is unlocked for the next 15 minutes, then carry out the main merge/push the user asked for (the window auto-expires; revoke early with `/main-push off`).
