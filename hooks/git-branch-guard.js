...
process.stdout.write(JSON.stringify({
  hookSpecificOutput: {
    ...
    permissionDecisionReason:
      '[toolkit] git-flow guard blocked this: it is ' + reason + '. Policy: all new work goes to the `dev` branch; `main`/`master` is only updated on the user\'s EXPLICIT approval. ' +
