...
const CMD_MD = ['dev', 'cover', 'pin', 'status', 'maxagents', 'bro', 'main-push', 'versioning', 'reality', 'research', 'autocompact', 'toolkit-reset', 'applied', 'hooks', 'doctor', 'sudo-on', 'sudo-off', 'devedit', 'classifier-window', 'settings-sync'];
const CMD_BACKENDS = ['_qdt', '_mode-toggle', '_cover', '_pin', '_status', '_maxagents', '_bro', '_main-push', '_versioning', '_reality', '_research', '_autocompact', '_toolkit-reset', '_applied', '_hooks', '_hookcat', '_stateview', '_doctor', '_sudoctl', '_devedit', '_classifier-window', '_settings-sync'];
...
for (const h of ['session-start-restore.js', 'pre-compact-steer.js', 'secret-guard.js', 'git-branch-guard.js', 'release-guard.js', 'skill-reminder.js', 'agent-limit.js', 'compact-warn.js', 'classifier-window-check.js', 'toolkit-reset-guard.js', 'checkpoint-nudge.js', 'devmode-guard.js', 'terminal-guard.js', '_hookutil.js']) rm(path.join(QHOME, 'hooks', h));
...
(function () {
  ...
  const names = new Set(['restore-progress', 'steer-compaction', 'compact-warn', 'classifier-window-check', 'secret-guard', 'git-branch-guard', 'release-guard', 'toolkit-reset-guard', 'devmode-guard', 'terminal-guard', 'skill-reminder', 'agent-limit-reset', 'agent-limit-pre', 'agent-limit-post', 'checkpoint-nudge']);
